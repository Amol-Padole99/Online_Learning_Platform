...
<link rel="shortcut icon" href="/resources/images/teacherimg.jpg"
	type="image/x-icon">
</head>
...
.navdiv {
	...
	background-image: linear-gradient(to right, rgba(107, 197, 222, 0.074),
		rgba(159, 211, 225, 0.189), rgba(181, 216, 224, 0.079));
	position: fixed;
	z-index: 999;
...
.homesec {
	...
	margin-top: 5rem;
	background-image: linear-gradient(to right, rgba(107, 197, 222, 0.074),
		rgba(159, 211, 225, 0.189), rgba(181, 216, 224, 0.079), white, white);
}
...
.cardsec {
	height: 90vh;
	width: 100vw;
	background-image: linear-gradient(to left, rgba(107, 197, 222, 0.074),
		rgba(159, 211, 225, 0.189), rgba(181, 216, 224, 0.079));
}
...
.subheading {
	...
	align-items: center;
	justify-content: center;
	background-image: linear-gradient(to left, rgba(66, 133, 152, 0.074),
		rgba(159, 211, 225, 0.189), rgba(181, 216, 224, 0.079), white, white);
	font-size: 2rem;
	font-weight: 600;
	...
	<div class="wrapper">
		...
		<div class="navdiv">
			...
			<div class="logoandbrand">
				<div class="logo">
					<a href="#home"><img
						src="https://img.freepik.com/free-vector/education-business-logo-template-branding-design-vector-education-center-text_53876-136247.jpg?t=st=1709134724~exp=1709138324~hmac=0da2aade431302b4f207a44b0024fbe7c37fd82b29ead7cdf5dfdd966ca2808c&w=740"
						alt="logoIMG"></a>
				</div>
			...
			<div class="logindiv">
				...
				<a href="logout-student">
					<div class="button" id="login">
						Logout <i class="fa-solid fa-right-to-bracket"
							style="color: white; margin-left: 5px;"></i>
					</div>
				</a> <a href="student-dashboard">
			...
			<div class="logindiv">
				...
				<a href="login-sm">
					...
					<div class="button" id="signup">
						SignUp <i class="fa-solid fa-user-plus"
							style="color: white; margin-left: 5px;"></i>
					</div>
				</a>
		...
		<div class="homesec" id="home">
			...
			<div class="hero-section-left">
				<div class="hero-section-heading">
					Welcome to <span id="herosubh">Study Buddy</span>,
				</div>
				...
				<div class="hero-section-description">Ready to Begin Your
				...
				<div class="herosecbtn">
					...
					<div class="button-2" id="watchbtn">
						<a href="https://www.youtube.com/@CodeWithHarry" target="_blank">Watch
							Videos</a>
					</div>
				</div>
			...
			<div class="home-rightimg">
				<img
					src="https://img.freepik.com/premium-vector/modern-flat-illustration-web-performance_203633-8811.jpg?w=740"
					alt="">
			</div>
		...
		<div class="cardsec">
			...
			<div class="cardinfo">
				...
				<p class="cardsubheading">Making learning easier and more
		...
		<div class="courses" id="courses">
			...
			<div class="coursecardcontainer">
				...
				<div class="child">
					...
					<div class="cards">
						...
						<p class="course-description"><%=ac.getcDescription()%>
						</p>
					...
					<div class="aboutcontainer">
						...
						<div class="abinfo">
							...
							<div class="abcont0">
								...
								<p class="abdescription">We believe in the transformative
									power of education. Our mission is to empower learners of all
									ages and backgrounds to unlock their full potential through
									accessible and innovative learning experiences. Whether you're
									a student, educator, or lifelong learner, we are here to
									inspire, guide, and support you on your educational journey.</p>
							</div>

							<div class="abcont1">
								<p class="abheading">Our Vision</p>
								<p class="abdescription">To create a world where education
									knows no boundaries. We envision a future where learning is a
									lifelong adventure, accessible to anyone, anywhere.</p>
							</div>

							<div class="abcont2">
								<p class="abheading">Who We Are?</p>
								<p class="abdescription">Study Buddy is not just an online
									learning hub; we are a community passionate about fostering
									curiosity, critical thinking, and continuous growth. Our team
									consists of educators, technologists, and enthusiasts dedicated
									to reshaping the educational landscape. Together, we are
									committed to providing a platform that goes beyond traditional
									boundaries, making learning engaging, interactive, and relevant
									to the dynamic needs of the 21st century.</p>
							</div>
						</div>

						<div class="abimg">
							<img
								src="https://img.freepik.com/free-vector/teamwork-concept-landing-page_52683-20165.jpg?t=st=1709134842~exp=1709138442~hmac=29874cf2fe85bc089eb4b33022b4aa89995bde08465def71532c34ba795fb193&w=740"
								alt="img">
						</div>
					</div>
				...
				<div class="contact" id="contactus">
					...
					<div class="subcontact">
						...
						<div class="con-leftdiv">
							<img
								src="https://img.freepik.com/free-vector/flat-design-illustration-customer-support_23-2148887720.jpg?t=st=1709134947~exp=1709138547~hmac=c2dfb4be28091e9182b057812afde215ab3957c7039b3def00df900370a3ad69&w=740"
								alt="contactimg">
						</div>

						<div class="con-rightdiv">

							<form action="https://formsubmit.co/omggaming2810@gmail.com"
								method="POST">
								...
								<label for="lname">Email ID</label> <input type="text"
									id="lname" name="Email ID" placeholder="Your Email ID..">
				...
				<div class="footer">
						...
						<div class="footcontainer">
							...
							<div class="t2">
								...
								<ul>
									...
									<li><a href="#aboutus">About Us</a></li>
									<li><a href="#contactus">Contact Us</a></li>
									<li><a href="http://localhost:8879/sm/login">Admin
											Login</a></li>
								</ul>
							</div>
					...
					<div class="bottomfooter">
						<p>Copyright © 2024 Study Buddy Technologies Pvt Ltd. All
							Rights Reserved.</p>
					</div>
			...
			<script src="https://kit.fontawesome.com/9e44236902.js"
				...
				var typeData = new Typed(".role",
						{
							...
							"Comprehensive Courses", "Flexible Learning",
