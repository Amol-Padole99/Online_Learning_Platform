...
<body>
	...
	<a href="post-doubts" class="btn btn-sm bg-danger text-white">Post
		Doubts</a>
	...
	<div class="card">
		...
		<div class="card-details">
			<span class="card-tags">Tags: <%=qpe.getTags()%></span> <span
				class="card-date">Date: <%=qpe.getCretaedAt()%>
			</span> <a href="view-solution?id=<%=qpe.getId()%>"
