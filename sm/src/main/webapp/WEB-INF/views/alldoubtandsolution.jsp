...
<body>
	...
	<div class="solution-card">
		...
		<p>
			<strong>Doubt ID: </strong><%=ope.getId()%></p>
		<p>
			<strong>Title: </strong><%=ope.getTitle()%>
		</p>
		<p>
			<strong>Detail Problem: </strong><%=ope.getTitle()%></p>
		<p>
			<strong>Expecting: </strong><%=ope.getExpectation()%></p>
		<p>
			<strong>Tag: </strong><%=ope.getTags()%></p>
		<p>
			<strong>Posted At: </strong><%=ope.getCretaedAt()%></p>
		<%
		if (ope.getSolution() == null) {
		%>
		<p>
			<strong>Solution: </strong>Solution to be posted soon.....
		</p>
		<%
		} else {
		%>
		<p>
			<strong>Solution: </strong><%=ope.getSolution()%></p>
		<%
		}
		%>
		<div class="thumbs-container">
			...
			<form action="dislikesolution/<%=ope.getId()%>/dislike"
				method="POST">
		...
		<a href="report-issue" class="btn btn-sm bg-danger text-white">Is
			there any mistake.?</a>
	</div>
	<%
