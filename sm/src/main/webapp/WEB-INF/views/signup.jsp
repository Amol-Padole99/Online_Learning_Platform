...
<body>
	<div class="container">
		...
		<div class="parent">
			...
			<img
				src="https://img.freepik.com/free-vector/sign-up-concept-illustration_114360-7875.jpg?t=st=1709134396~exp=1709137996~hmac=de9d0df585ce56abaefa184c56fb99a82f1b7ce3f46770e1de1da3e799651c80&w=740"
				alt="">
			<form id="signupForm" action="signup" method="POST">
				<p class="form-heading">Sign up and start learning</p>
				<input type="text" name="fname" id="fname" placeholder="First name"
					required> <input type="text" name="lname" id="lname"
					placeholder="Last name" required> <input type="email"
					name="email" id="email" placeholder="Email Address" required>

				<input type="number" name="mob" id="mob" placeholder="Phone Number"
					required> <input type="password" name="password"
					id="password" placeholder="Password" required> <input
					type="submit" value="Sign Up">

				<p>
					Already have an account? <a href="login-sm">Log in</a>
				</p>
			</form>
		</div>
	</div>
