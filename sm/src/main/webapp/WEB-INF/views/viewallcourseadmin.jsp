...
<body>
	<h1 style="color: blue; text-transform: uppercase; text-align: center;">Course
		Information Admin Panel</h1>
	<%
	if (message != null) {
	%>
	...
	<table>
		...
		<tr>
			...
			<td><img src="<%=ac.getImg()%>" alt="Course Image"
				style="max-width: 100px;"></td>
			<td><%=ac.getPrice()%></td>
			<td class="btn-container"><a
				href="edit-cource-admin/<%=ac.getId()%>" class="btn btn-edit">Edit</a>
