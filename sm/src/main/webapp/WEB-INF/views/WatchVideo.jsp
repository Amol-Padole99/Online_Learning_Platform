...
<body>
	...
	<div class="container">
		<div class="sidebar">
			<ul id="lecture-list">
				<li><a href="javascript:void(0);"
					onclick="toggleSubLectures(this)"> <span class="arrow"></span>
						Lecture 1
				</a>
					<ul class="sub-lectures">
						<li><a href="javascript:void(0);"
							onclick="showLecture('SubLecture1VideoID', 1.1)">Lecture 1.1</a></li>
						<li><a href="javascript:void(0);"
							onclick="showLecture('SubLecture2VideoID', 1.2)">Lecture 1.2</a></li>
					</ul></li>
				<li><a href="javascript:void(0);"
					onclick="toggleSubLectures(this)"> <span class="arrow"></span>
						Lecture 2
					...
					<ul class="sub-lectures">
						<li><a href="javascript:void(0);"
							onclick="showLecture('SubLecture3VideoID', 2.1)">Lecture 2.1</a></li>
						<li><a href="javascript:void(0);"
							onclick="showLecture('SubLecture4VideoID', 2.2)">Lecture 2.2</a></li>
					</ul></li>
			</ul>
		</div>
		...
		<div class="content">
			...
			<p id="lecture-name">Select a lecture from the sidebar to view
				its content.</p>
		</div>
	</div>
