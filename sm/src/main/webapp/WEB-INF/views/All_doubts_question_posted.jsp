...
<body>
	...
	<div class="card">
		<!-- <h6doubt.getId()d() %> </h6> -->
		<h2 class="card-title">
			Title:<%=doubt.getTitle()%></h2>
		<div class="card-details">
			<span class="card-tags">Tags:<%=doubt.getTags()%></span> <span
				class="card-date">Date: <%=doubt.getCretaedAt()%>
			</span> <a href="view-solution?id=<%=doubt.getId()%>"
